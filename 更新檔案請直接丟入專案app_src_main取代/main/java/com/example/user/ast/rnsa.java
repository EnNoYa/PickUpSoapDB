...
public class rnsa extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if(ContextCompat.checkSelfPermission(rnsa.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
      if(ActivityCompat.shouldShowRequestPermissionRationale(rnsa.this, Manifest.permission.READ_EXTERNAL_STORAGE)){
        ActivityCompat.requestPermissions(rnsa.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, MY_PERMISSION_REQUEST);
      }
      else{
        ActivityCompat.requestPermissions(rnsa.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, MY_PERMISSION_REQUEST);
      }
    ...
    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        try {
          ...
          Toast.makeText(rnsa.this, "失敗", Toast.LENGTH_SHORT).show();
          e.printStackTrace();
        }
      }
    });
    ...
    switch (RequestCode){
      case MY_PERMISSION_REQUEST:
        if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
          if(ContextCompat.checkSelfPermission(rnsa.this, Manifest.permission.READ_EXTERNAL_STORAGE) ==
                  PackageManager.PERMISSION_GRANTED){
            Toast.makeText(rnsa.this, "授權成功", Toast.LENGTH_SHORT).show();
            dostuff();
          }
          else{
            Toast.makeText(rnsa.this, "授權失敗", Toast.LENGTH_SHORT).show();
            finish();
          }
        }
        break;
